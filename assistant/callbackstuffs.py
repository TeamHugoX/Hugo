...
from pyHugo.functions.gdrive import authorize, create_token_file
from pyHugo.functions.tools import get_paste, telegraph_client
from pyHugo.startup.loader import Loader
...
async def send(eve):
    ...
    thumb = "resources/extras/inline.png"
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "pyHugo")
...
async def changes(okk):
    ...
    repo = Repo.init()
    ac_br = repo.active_branch
    button = (Button.inline("ᴜᴘᴅᴀᴛᴇ ɴᴏᴡ", data="updatenow"),)
    ...
    if Carbon:
        try:
            ...
            return await okk.edit(
                f"**• Hugo Userbot •**{cli}", file=img, buttons=button
            )
    ...
    if len(changelog_str) > 1024:
        ...
        with open("hugo_updates.txt", "w+") as file:
            file.write(tl_chnglog)
        await okk.edit(
            get_string("upd_5"),
            file="hugo_updates.txt",
            buttons=Button.inline("ᴜᴘᴅᴀᴛᴇ ɴᴏᴡ", data="updatenow"),
        )
        remove("hugo_updates.txt")
        return
    await okk.edit(
        changelog_str,
        buttons=button,
...
async def _(e):
    ...
    await e.edit(
        ...
        buttons=Button.inline("« ʙᴀᴄᴋ", data=data),
        link_preview=False,
        parse_mode="html",
    )
...
async def _(e):
    ...
    await e.reply(
        "`Success!\nYou are all set to use Google Drive with Hugo Userbot.`",
        buttons=Button.inline("ᴍᴀɪɴ ᴍᴇɴᴜ", data="setter"),
    )
...
async def _(e):
    ...
    await e.edit(
        ...
        buttons=[
            [
                Button.inline("ᴄʟɪᴇɴᴛ ɪᴅ", data="clientid"),
                Button.inline("ᴄʟɪᴇɴᴛ sᴇᴄʀᴇᴛ", data="clientsec"),
            ],
            [
                Button.inline("ғᴏʟᴅᴇʀ ɪᴅ", data="folderid"),
                Button.inline("ᴀᴜᴛʜᴏʀɪsᴇ", data="authorise"),
            ],
...
async def otvaar(event):
    await event.edit(
        "Other Variables to set for @HugoProject:",
        buttons=[
            [
            ...
            [
                ...
                Button.inline("sᴜᴅᴏ ʜɴᴅʟʀ", data="shndlr"),
            ],
            [Button.inline("ᴅᴜᴀʟ ᴍᴏᴅᴇ", "oofdm")],
...
async def euwhe(event):
    BT = [
        [Button.inline("ᴅᴜᴀʟ ᴍᴏᴅᴇ ᴏɴ", "dmof")],
        [Button.inline("ᴅᴜᴀʟ ᴍᴏᴅᴇ ᴏғғ", "dmof")],
        [Button.inline("ᴅᴜᴀʟ ᴍᴏᴅᴇ ʜɴᴅʟʀ", "dmhn")],
    ]
    await event.edit(
...
async def tagloggrr(e):
    ...
    await e.edit(
        "Choose Options",
        buttons=[BUTTON, [Button.inline("« ʙᴀᴄᴋ", data="otvars")]],
    )
...
async def pmset(event):
    if not udB.get("ADDONS"):
        BT = [Button.inline("ᴀᴅᴅᴏɴs  ᴏɴ", data="edon")]
    else:
        BT = [Button.inline("ᴀᴅᴅᴏɴs  ᴏғғ", data="edof")]
    await event.edit(
...
async def pmset(event):
    if not udB.get("SUDO"):
        BT = [Button.inline("sᴜᴅᴏ ᴍᴏᴅᴇ  ᴏɴ", data="onsudo")]
    else:
        BT = [Button.inline("sᴜᴅᴏ ᴍᴏᴅᴇ  ᴏғғ", data="ofsudo")]
    await event.edit(
...
async def alvcs(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("ᴅᴇʟᴇᴛᴇ ᴀʟɪᴠᴇ ᴍᴇᴅɪᴀ", data="delmed")],
            [Button.inline("« ʙᴀᴄᴋ", data="setter")],
        ],
    )
    ...
    await event.edit(
        ...
        buttons=[
            ...
            [
                ...
                Button.inline("ᴘᴍʟᴏɢɢᴇʀ", data="pml"),
            ],
            [
                Button.inline("sᴇᴛ ᴡᴀʀɴs", data="swarn"),
                Button.inline("ᴅᴇʟᴇᴛᴇ ᴘᴍ ᴍᴇᴅɪᴀ", data="delpmmed"),
            ],
            [Button.inline("ᴘᴍᴘᴇʀᴍɪᴛ ᴛʏᴘᴇ", data="pmtype")],
...
async def inl_on(event):
    ...
    await event.edit(
        ...
        buttons=[[Button.inline("« ʙᴀᴄᴋ", data="pmtype")]],
    )
...
async def name(event):
    m = range(1, 10)
    thgd = [Button.inline(f"{x}", data=f"wrns_{x}") for x in m]
    lst = list(zip(thgd[::3], thgd[1::3], thgd[2::3]))
    lst.append([Button.inline("« ʙᴀᴄᴋ", data="pmcstm")])
    await event.edit(
...
async def alvcs(event):
    ...
    await event.edit(
        ...
        buttons=[
            BT,
            [Button.inline("ᴘᴍʟᴏɢɢᴇʀ ɢʀᴏᴜᴘ", "pmlgg")],
            [Button.inline("« ʙᴀᴄᴋ", data="pmcstm")],
        ],
    )
...
async def pmset(event):
    await event.edit(
        "PMPermit Settings:",
        buttons=[
            [Button.inline("ᴛᴜʀɴ ᴘᴍᴘᴇʀᴍɪᴛ ᴏɴ", data="pmon")],
            [Button.inline("ᴛᴜʀɴ ᴘᴍᴘᴇʀᴍɪᴛ ᴏғғ", data="pmoff")],
            [Button.inline("ᴄᴜsᴛᴏᴍɪᴢᴇ ᴘᴍᴘᴇʀᴍɪᴛ", data="pmcstm")],
            [Button.inline("« ʙᴀᴄᴋ", data="setter")],
        ],
    )
