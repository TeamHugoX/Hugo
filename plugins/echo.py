...
from pyHugo.dB.echo_db import add_echo, check_echo, list_echo, rem_echo
from telethon.utils import get_display_name

from . import LOGS, eor, events, hugo_bot, hugo_cmd


@hugo_cmd(pattern="addecho ?(.*)")
async def echo(e):
