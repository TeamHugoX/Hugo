...
from . import HNDLR, eod, eor, get_string, get_user_id, hugo_cmd


@hugo_cmd(pattern="dm", fullsudo=True)
async def dm(e):
...
@hugo_cmd(pattern="fwdreply ?(.*)", fullsudo=True)
async def _(e):
