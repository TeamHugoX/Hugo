...
from pyHugo.functions.misc import create_instagram_client
from telethon.tl.types import InputWebDocument

from . import LOGS, eor, get_string, in_pattern, types, udB, hugo_cmd


@hugo_cmd(pattern="instadl ?(.*)")
...
async def soon_(e):
    ...
    await e.reply(
        ...
        file=photo,
        force_document=True,
        attributes=[types.DocumentAttributeFilename("InstaHugo.jpg")],
    )
    await ew.delete()


@hugo_cmd(pattern="(instaul|reels|igtv) ?(.*)")
