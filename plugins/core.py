...
from pyHugo.startup.loader import load_addons

from . import eod, eor, get_string, requests, safeinstall, hugo_cmd, un_plug


@hugo_cmd(pattern="install", fullsudo=True)
...
@hugo_cmd(pattern="getaddons ?(.*)", fullsudo=True)
