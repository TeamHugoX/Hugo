...
from pyHugo.dB.snips_db import add_snip, get_snips, list_snip, rem_snip
from pyHugo.functions.tools import create_tl_btn, format_btn, get_msg_button
from pyHugo.misc import sudoers
from telegraph import upload_file as uf
from telethon.utils import pack_bot_file_id

from . import eor, events, get_string, mediainfo, hugo_bot, hugo_cmd
from ._inline import something


@hugo_cmd(pattern="addsnip ?(.*)")
async def an(e):
    ...
    for z in xx:
        ...
        if k:
            ...
            if rep:
                ...
                await hugo_bot.send_message(e.chat_id, msg, file=media)
