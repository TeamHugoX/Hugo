...
from pyHugo.dB.chatBot_db import add_chatbot, get_all_added, rem_chatbot
from pyHugo.functions.tools import get_chatbot_reply

from . import eod, eor, get_string, inline_mention, hugo_cmd


@hugo_cmd(pattern="repai")
